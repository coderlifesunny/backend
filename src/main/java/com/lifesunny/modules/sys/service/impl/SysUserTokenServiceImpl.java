...
import com.lifesunny.modules.sys.dao.SysUserTokenDao;
import com.lifesunny.modules.sys.entity.SysUserTokenEntity;
import com.lifesunny.modules.sys.oauth2.TokenGenerator;
...
public class SysUserTokenServiceImpl extends ServiceImpl<SysUserTokenDao, SysUserTokenEntity> implements SysUserTokenService {
    ...
    @Override
    public HttpResult createToken(long userId) {
        //生成一个token
        ...
        HttpResult httpResult = HttpResult.ok().put("token", token).put("expire", EXPIRE);
